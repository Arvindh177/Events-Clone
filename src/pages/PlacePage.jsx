...
export default function PlacePage() {
            ...
            <div className="absolute inset-0 bg-black text-white min-w-full min-h-screen">
                <div className="bg-black p-8 grid gap-4">
                    <div>
                        ...
                        <button onClick={()=> setShowAllPhotos(false)}className="fixed right-9 top-8 flex gap-1 py-2 px-4 rounded-2xl bg-primary text-white shadow shadow-black">
    ...
    return(
        <div className="mt-8 bg-gray-200 -mx-8 px-8 pt-8">
        ...
        <button onClick={()=> setShowAllPhotos(true)} className="absolute flex gap-1 bottom-0 right-0 py-2 px-4 bg-white rounded-2xl shadow shadow-md shadow-gray-500">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
